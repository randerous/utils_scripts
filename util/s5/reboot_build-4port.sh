...
read -p "subnet3 (without prefix): " subnet3
[[ $subnet3 == "" ]] && subnet3=13.13.13.11
read -p "subnet4 (without prefix): " subnet4
[[ $subnet4 == "" ]] && subnet4=14.14.14.11
...
do
	...
	then
        ...
        then
                targetcli /iscsi/iqn.2023-07.iscsi.test$i:client/tpg1/portals create $subnet3
                targetcli /iscsi/iqn.2023-07.iscsi.test$i:client/tpg1/acls/ create $iqn2
	else
		targetcli /iscsi/iqn.2023-07.iscsi.test$i:client/tpg1/portals create $subnet4
                targetcli /iscsi/iqn.2023-07.iscsi.test$i:client/tpg1/acls/ create $iqn2
	fi
done
}
